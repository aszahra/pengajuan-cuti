<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                ...
                <div class="bg-white shadow-lg rounded-lg p-4">
                    <h3 class="text-lg font-bold">Cuti Menunggu</h3>
                    <p id="pendingCount" class="text-2xl font-semibold text-yellow-600 pt-3">0</p>
                </div>
            </div>
            ...
            <div class="mt-6">
                <div class="flex space-x-2 mb-4">
                    <input type="text" id="searchInput" placeholder="Cari nama..."
                        class="border p-2 rounded-md w-1/3" oninput="filterTable()">
    ...
    <script>
        ...
        const leaveRequests = [
            { id: 1, name: 'Aceng Ziran Fauji', startDate: '2025-03-01', endDate: '2025-03-05', leaveType: 'Cuti Tahunan', status: 'pending' },
            { id: 2, name: 'Aisyah Siti Zahra', startDate: '2025-03-02', endDate: '2025-03-06', leaveType: 'Cuti Sakit', status: 'approved' },
            { id: 3, name: 'Andika Herviantino Pratama', startDate: '2025-03-03', endDate: '2025-03-07', leaveType: 'Cuti Besar', status: 'rejected' },
            { id: 4, name: 'Arafian Hafiz', startDate: '2025-03-04', endDate: '2025-03-08', leaveType: 'Cuti Menikah', status: 'pending' },
            { id: 5, name: 'Dimas Novi Fitriyansyah', startDate: '2025-03-05', endDate: '2025-03-09', leaveType: 'Cuti Studi', status: 'pending' },
            { id: 6, name: 'Emil Awaliadi', startDate: '2025-03-06', endDate: '2025-03-10', leaveType: 'Cuti Tahunan', status: 'pending' },
            { id: 7, name: 'Fazhari Rizky Rahmathun', startDate: '2025-03-07', endDate: '2025-03-11', leaveType: 'Cuti Besar', status: 'rejected' },
            { id: 8, name: 'Kelvin Leonardo', startDate: '2025-03-08', endDate: '2025-03-12', leaveType: 'Cuti Menikah', status: 'pending' },
            { id: 9, name: 'Muhamad Ali Akbar Abil Aziz', startDate: '2025-03-09', endDate: '2025-03-13', leaveType: 'Cuti Sakit', status: 'approved' },
            { id: 10, name: 'Muhamad Arfan Maulan', startDate: '2025-03-10', endDate: '2025-03-14', leaveType: 'Cuti Tahunan', status: 'pending' },
            { id: 11, name: 'Muhamad Irfan Sujono', startDate: '2025-03-11', endDate: '2025-03-15', leaveType: 'Cuti Studi', status: 'pending' },
            { id: 12, name: 'Muhammad Farhan Saefulloh', startDate: '2025-03-12', endDate: '2025-03-16', leaveType: 'Cuti Besar', status: 'rejected' },
            { id: 13, name: 'Muhammad Rasyid Ridho', startDate: '2025-03-13', endDate: '2025-03-17', leaveType: 'Cuti Menikah', status: 'pending' },
            { id: 14, name: 'Puji Haryadi', startDate: '2025-03-14', endDate: '2025-03-18', leaveType: 'Cuti Sakit', status: 'pending' },
            { id: 15, name: 'Rian Afrizal', startDate: '2025-03-15', endDate: '2025-03-19', leaveType: 'Cuti Tahunan', status: 'approved' },
            { id: 16, name: 'Rizky Al-Ikhsan', startDate: '2025-03-16', endDate: '2025-03-20', leaveType: 'Cuti Besar', status: 'rejected' },
            { id: 17, name: 'Sinta Aulia Wardani', startDate: '2025-03-17', endDate: '2025-03-21', leaveType: 'Cuti Menikah', status: 'pending' },
            { id: 18, name: 'Tazkia Hidayatuloh Al Mahrom', startDate: '2025-03-18', endDate: '2025-03-22', leaveType: 'Cuti Studi', status: 'pending' },
            { id: 19, name: 'Yogi Febriandi', startDate: '2025-03-19', endDate: '2025-03-23', leaveType: 'Cuti Tahunan', status: 'pending' }
        ];
