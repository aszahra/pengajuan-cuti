                        ...
                        <table id="leaveRequestsTable" class="min-w-full border-collapse border border-gray-200">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th onclick="sortTable(2)" class="border p-3 text-left cursor-pointer">Tanggal Mulai
                                    </th>
                                    <th onclick="sortTable(3)" class="border p-3 text-left cursor-pointer">Tanggal Selesai
                                    </th>
